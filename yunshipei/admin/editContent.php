...
<head>
    ...
    <style>
        ...
        .other{width: 72px;}
        .picture img{width: 360px;}
    </style>
</head>
<body>
<div class="container">
    <h3>添加内容</h3>
    <form action="editContentData.php?sid=<?php echo $_GET["sid"];?>" method="post">
        <?php
            $sid = $_GET["sid"];
            $cid = $_GET["cid"];
        ...
        内容标题:<input type="text" name="title" value="<?php echo $row['stitle'];?>"><br>
        内容：<script id="container" name="content" type="text/plain"></script>
        <!--上传照片-->
        <div class="parent">
            <div class="picture"><img src="<?php echo $row['img'];?>" alt=""></div>
            <input type="hidden" name="img">
            <input type="file" multiple>
        </div>
        作者：<input type="text" name="author" value="<?php echo $row['author'];?>"><br>
